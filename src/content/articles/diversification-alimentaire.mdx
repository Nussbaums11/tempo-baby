...
<div class="bg-cream border border-border rounded-xl px-6 py-5 my-7">
  ...
  <ol class="pl-5 mb-0">
    <li>Quand commencer : 4 mois, 6 mois, ou "quand bébé est prêt" ?</li>
    <li>DME ou purées : deux approches, pas une bonne et une mauvaise</li>
    <li>Allergies alimentaires : ce qu'on recommande aujourd'hui</li>
    <li>Bébé refuse de manger : les causes les plus fréquentes</li>
...
Entre les deux, selon les signes de développement de bébé (tenue de tête, intérêt pour la nourriture, disparition du réflexe d'extrusion), voir la section 1.

#### Qu'est-ce que la DME ?
La diversification menée par l'enfant : bébé porte lui-même des morceaux adaptés à sa bouche, en complément ou à la place des purées.
...
<div class="flex gap-3 items-start bg-cream rounded-xl px-5 py-4 my-7">
  ...
  <p class="text-sm text-ink/70 m-0"><strong class="text-ink">Rédigé par l'équipe Tempo</strong>, contenu construit à partir des recommandations de santé publique françaises. Contenu à visée informative, ne remplace pas une consultation médicale.</p>
</div>

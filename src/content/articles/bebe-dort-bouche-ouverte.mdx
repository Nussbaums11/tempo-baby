...
Quand ces signes s'installent, la question dépasse la bouche ouverte et rejoint celle d'un [trouble du sommeil chez le bébé](/trouble-du-sommeil-bebe/), qui se travaille avec un professionnel. Deux pistes sont alors régulièrement explorées : une apnée du sommeil chez le bébé, et le fait qu'un bébé ne dort pas correctement de façon durable malgré un environnement adapté.

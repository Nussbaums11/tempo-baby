...
Votre bébé dormait plutôt bien, et voilà qu'il se réveille toutes les heures, refuse ses siestes ou pleure au moment du coucher. Ce coup de frein soudain porte un nom : la régression du sommeil. La bonne nouvelle, c'est que c'est presque toujours une étape passagère, liée au développement de votre enfant, et non un problème durable du [sommeil de bébé](/sommeil-bebe/). Voici à quels âges ces régressions surviennent, combien de temps elles durent, et comment traverser ces périodes le plus sereinement possible.
...
Vers 4 mois, le sommeil de votre bébé se transforme en profondeur. C'est souvent la régression la plus impressionnante, parce qu'elle correspond à une réorganisation durable de sa façon de dormir. À la naissance, le sommeil est simple ; vers 4 mois, il se structure en véritables cycles, avec des phases de sommeil plus léger entre lesquelles bébé se réveille plus facilement. Cette maturation des [cycles de sommeil de bébé](/cycle-sommeil-bebe/) est un vrai progrès, mais elle s'accompagne fréquemment de réveils multiples le temps que le nouveau fonctionnement s'installe. La régression du sommeil à 4 mois dure en général de deux à six semaines, un peu plus que les suivantes.
...
Ces réflexes prolongent, sur une période un peu chahutée, les grands leviers d'aide au sommeil de bébé au quotidien.

## Régression passagère ou vrai trouble du sommeil : quand consulter ?

Une régression du sommeil est temporaire et se résout d'elle-même en quelques semaines. Quand les difficultés s'installent au-delà d'un mois, reviennent sans lien avec une étape de développement, ou s'accompagnent d'autres signes, il peut s'agir d'autre chose qu'une régression. La frontière avec un véritable [trouble du sommeil du bébé](/trouble-du-sommeil-bebe/) n'est pas toujours évidente à tracer seul.
...
- [Ameli (Assurance Maladie), sommeil de l'enfant](https://www.ameli.fr/assure/sante/themes/troubles-sommeil-enfant) : étapes, réveils et quand consulter.
- [Inserm](https://www.inserm.fr/dossier/sommeil/), dossier d'information sur le sommeil et son organisation en cycles et en phases.
- [Réseau Morphée](https://sommeilenfant.reseau-morphee.fr/), ressources sur le sommeil de l'enfant de la naissance à 3 ans.

{/* ARBITRAGE SŒURS 01/09/2026 (Sandra) : cette page ne garde que cycle sommeil bébé, trouble du sommeil bébé en liens de sœur (règle : 1 à 2 max). Les mentions en clair de aide sommeil bébé sont VOLONTAIREMENT non liées, ne pas les réactiver au maillage. Ancres orphelines semées : aucune (les sujets des frères non encore publiés du cocon ne sont pas réellement effleurés ; la maturation des cycles est renvoyée vers cycle-sommeil-bebe déjà publié). */}
